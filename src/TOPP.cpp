...
//        bound = constraints.mvccombined[0];
    ...
    int resintfw = IntegrateForward(constraints,0,sdbegmax,constraints.integrationtimestep,tmpprofile,MAX_INT_STEPS,testaboveexistingprofiles,testmvc,zlajpah);
